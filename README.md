...
### Multiple imputation workflow for missing lactate values

1. [Multiple Imputation of lactate values with predictive mean matching](analysis/_2_imputation_lactate.do)
2. Assessment of the imputation effect on study-specific settings. In our example, this was conducted assessing the reclassification of IABP-SHOCK II risk score when lactate is imputed through our workflow vs naive imputations (all missing data imputed to 0). Study-specific files:
